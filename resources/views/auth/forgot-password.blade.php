            ...
            <section class="h-screen bg-gradient-to-br">
                <div class="min-h-screen flex max-w-4xl mx-auto">
                        ...
                        <div class="max-w-md w-full space-y-8">
                            ...
                            <div class="text-left">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-gray-600 text-sm">Enter your registered email and we’ll <br> send you a reset link.</p>
                                </div>
                            </div>

                            <!-- Login Form -->
                            <form class="mt-8 space-y-6" method="POST" action="{{ route('password.email') }}" novalidate>
                                @csrf
                                <div class="space-y-4">
                                    <div>
                                        <label
                                ...
                                <div class="text-center">
                                    <p
                                        ...
                                        Change mind?
                                        <a href="{{route('login')}}" class="text-benue-green text-green-800 font-bold"
                                            >Login</a
                                        >
                                    </p>
                                </div>
                    ...
                    <div class="hidden lg:block lg:w-1/2 relative">
                        <img
                            src="{{asset('/assets/images/signup-image.png')}}"
                        ...
                        <div class="relative h-full flex items-center justify-center">
                            <div class="text-center p-8">
                                ...
                                <div
                                    class="relative z-40 w-76 h-76 mx-auto mb-8 rounded-full flex items-center justify-center backdrop-blur-sm">
                                    <div
                                        class="w-76 h-auto bg-white/30 rounded-full flex items-center justify-center">
                                        <img
                                            src="{{asset('/assets/images/benue-logo.png')}}"
