...
<body class="bg-gray-50">
    <header class="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
                    ...
                    <div class="relative group">
                        ...
                        <div
                            ...
                            <div class="py-2">
                                ...
                                <a href="resources.html" data-page="resources"
                                    class="flex items-center px-4 py-3 text-sm text-gray-700 transition-colors duration-200 dropdown-link hover:bg-green-600 hover:text-white">
                                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div id="mobile-menu" class="hidden bg-white border-t border-gray-200 lg:hidden">
            <div class="px-4 pt-4 pb-6 space-y-2">
                ...
                <div class="space-y-1">
                    <button onclick="toggleMobileSubmenu()" data-page="media"
                        ...
                        Media
                        <svg id="submenu-arrow" class="w-5 h-5 transition-transform duration-200" fill="none"
                ...
                <div class="pt-4 border-t border-gray-200">
                    <button
                        ...
                        <a href="authentication/register.html">Get Started</a>
                    </button>
                </div>
            </div>
        </div>
    ...
    <footer class="px-16 py-10 text-white bg-green-800 md:py-12">
        <div class="grid grid-cols-1 gap-8 mx-auto max-w-7xl sm:grid-cols-2 md:grid-cols-4 md:gap-10">
            <!-- Logo & Description -->
            <div class="space-y-4">
                <!-- Logo and Brand -->
                <div class="flex items-center space-x-4">
            ...
            <!-- Contact -->
            <div class="space-y-4">
                <h3 class="font-sora font-bold text-base leading-[120%] tracking-normal text-[#FFFFFF]">
                    Contact
                </h3>
                <ul class="text-[13px] leading-[120%] tracking-normal font-sora font-normal space-y-4 text-white">
                    ...
                    <li class="flex items-start gap-3">
                        <span class="flex-shrink-0 w-5 h-5 mt-1">
                            <img src="{{ asset('assets/images/phone-icon.png') }}" alt="Phone"
                                class="object-contain w-full h-full" />
                        </span>
                    ...
                    <li class="flex items-start gap-3">
                        <span class="flex-shrink-0 w-5 h-5 mt-1">
                            <img src="{{ asset('assets/images/skype icon.png') }}" alt="Skype"
                                class="object-contain w-full h-full" />
                        </span>
            ...
            <div class="space-y-4">
                ...
                <ul class="text-[13px] leading-[120%] tracking-normal font-sora font-normal space-y-2">
            ...
            <div class="space-y-4">
                ...
                <ul class="text-[13px] leading-[120%] tracking-normal font-sora font-normal space-y-3 text-white">
                    <li>
                        <a href="#" class="flex items-center gap-2 hover:underline">
                            ...
                            <span class="flex-shrink-0 w-4 h-4">
                                <img src="{{ asset('assets/images/solar_arrow-right-up-broken.png') }}"
                                    alt="External link icon" class="object-contain w-full h-full" />
                            </span>
                        </a>
                    </li>
                    <li>
        ...
        <div
            ...
            <div class="flex items-center gap-2">
                <span class="text-[14px] leading-[100%] tracking-[2%] font-sora font-normal">Powered by</span>
                <img src="{{ asset('assets/images/bdiclogo.png') }}" alt="BDIC Logo" class="w-10 h-auto" />
            </div>
        </div>
    </footer>
